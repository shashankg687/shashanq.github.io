...
We organize thematic workshops, invited talks, and training programs on quantum information, quantum cryptography, and post‑quantum security to strengthen the local and national quantum research ecosystem and engage with the broader scientific community.

Tools & Expertise
======

Members of Qurious Labs work with:

* **Theoretical Frameworks**: Quantum information theory, open quantum systems, non‑Markovian dynamics, device-independent frameworks, and communication complexity theory.

* **Software Platforms**: Python, MATLAB/Simulink, QuTiP, Qiskit, Mathematica, and custom simulation pipelines optimized for QKD, QRNG, and network-level analysis.

* **Security & Protocol Design**: End‑to‑end design and validation of quantum communication schemes, including protocol optimization, parameter estimation, security proofs, and experimental feasibility assessment.

* **Implementation & Modeling**: From theoretical protocols to realistic models incorporating experimental constraints, noise, and device imperfections.

Joining Qurious Labs
======

We welcome **motivated undergraduate students**, **master's degree candidates**, **Ph.D. researchers**, and **postdoctoral scientists** with strong interest in:

* Quantum information theory and quantum walks
* Quantum key distribution and quantum cryptography
* Quantum entanglement and multipartite quantum systems
* Quantum networks and multi‑party quantum computation
* Post‑quantum and hybrid cryptographic schemes
* Numerical and experimental modeling of quantum protocols
* Quantum simulation and photonics

If you are passionate about quantum technologies and interested in contributing to fundamental and applied quantum research, we encourage you to reach out with:
